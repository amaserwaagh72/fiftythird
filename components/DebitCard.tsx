...
const DebitCard = ({ cardNumber = '**** **** **** 7890', cardHolder = 'JAMES ANDERSON', expiryDate = '12/28', cvv = '***' }: DebitCardProps) => {
  ...
  return (
    <div
      className="bg-[#081a44] relative shadow-sm rounded-2xl p-6 cursor-pointer transition-all duration-300 ease-out transform-style-3d"
      style={{
    ...
    >
      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-white text-sm font-medium max-w-[200px] uppercase tracking-wide">{cardHolder}</p>
        </div>
