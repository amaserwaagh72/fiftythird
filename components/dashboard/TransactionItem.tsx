...
const TransactionItem = ({ merchant, category, date, amount, status = 'success' }: TransactionItemProps) => {
  ...
  return (
    <div className="flex items-center gap-3 py-3 border-b border-gray-200 last:border-0 hover:bg-[#081a44]/10 -mx-2 px-2 rounded-lg transition-colors cursor-pointer">
